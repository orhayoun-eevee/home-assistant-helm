...
This chart deploys Home Assistant using the shared dependency `lib-chart` (`0.0.15`) in two contexts:
...
- `application` alias of `lib-chart` (`0.0.15`) from `oci://ghcr.io/orhayoun-eevee`
